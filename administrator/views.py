...
def create(request):
    ...
    return render(request, 'administrator/create.html', {'tab_users': user_list,
...
def view(request, ticket_id=1):
    ...
    return render(request, 'administrator/view.html', {'ticket': ticket, 'status_list': status_list, 'ticket_comments': ticket_comments})
...
def view_all(request):
    ...
    return render(request, 'administrator/view_all.html', {'tickets': tickets,'my_tickets':my_tickets, 'filter': filter,
...
def submit_comment(request, ticket_id):
    ...
    return HttpResponseRedirect(f"/administrator/view/{ticket.id}/")
...
def delete_comment(request, comment_id):
    ...
    return HttpResponseRedirect("/administrator/view/" + str(comment.ticket.id) + "/")
